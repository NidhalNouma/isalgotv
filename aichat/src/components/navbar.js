...
function Navbar({ className, onMenuClick, onMenuHover, page, changePage }) {
  const { user } = useUser();
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          >
            {false ? (
              <svg
                className="h-6 aspect-square fill-title stroke-title hover:fill-title/80 hover:stroke-title/80 transition-colors"
                viewBox="0 0 302 428"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
        ...
        {user && isPage ? (
          <div className="relative">
            <button
              ...
              onClick={() => window.openCustomDropdown("user-dropdown")}
            >
              <svg
                strokeWidth="0"
                viewBox="0 0 24 24"
                className="w-6 aspect-auto fill-current stroke-current"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  fillRule="evenodd"
            ...
            <div
              className="px-4 z-50 absolute top-8 right-6 hidden text-base list-none bg-text/10 backdrop-blur-3xl rounded-md shadow"
              id="user-dropdown"
            >
              {user.tradingviewUsername && (
                <div className="px-0.5 py-0 pt-2 text-center">
              ...
              <ul className="py-2">
                <li>
                  <buttom
                    ...
                    className="cursor-pointer px-4 py-2 text-sm text-text/90 hover:text-title flex items-center transition-all"
                  >
                    <svg
                ...
                {/* <li>
                  <a
                    ...
                    className="px-4 py-2 text-sm text-text/90 hover:text-title flex items-center transition-all"
                  >
                    <svg
                ...
                <li>
                  <a
                    href="/"
                    className="flex items-center px-4 py-2 text-sm text-text/80 hover:text-title transition-all"
                  >
                    <svg
                      className="h-4 w-4 mr-1"
                      stroke="currentColor"
