...
export function DeleteConfirmPopup({ children, title, onClose, onDelete }) {
  return (
    <Fragment>
      <div className="fixed inset-0 backdrop-color z-40" onClick={onClose} />
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md z-50 p-8">
...
export function TokensPopup({ onClose, user, tokens }) {
  return (
    <Fragment>
      <div className="fixed inset-0 backdrop-color z-40" onClick={onClose} />
...
export function SettingsPopup({ onClose, user }) {
