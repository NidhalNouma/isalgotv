...
class TradeDetails(models.Model):
    ...
    volume = models.DecimalField(decimal_places=2, max_digits=10, default=0)
    remaining_volume = models.DecimalField(decimal_places=2, max_digits=10, default=0)
