...
urlpatterns = [
    ...
    path('automate/kraken', automate_kraken, name='docs_automate_broker_kraken'),
    path('automate/okx', automate_okx, name='docs_automate_broker_okx'),
    path('automate/apex', automate_apex, name='docs_automate_broker_apex'),
    path('automate/hyperliquid', automate_hyperliquid, name='docs_automate_broker_hyperliquid'),
